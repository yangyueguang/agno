...
class ChromaDb:
    def __init__(self, collection: str, embedder: Optional[Embedder] = None, path: str = 'tmp/chromadb', persistent_client: bool = False, reranker=None, **kwargs):
...
class AgentKnowledge:
    ...
    def __init__(self, urls: List[str], vector_db: ChromaDb = None, num_documents=5, optimize_on=1000, docs: List[Document] = None):
